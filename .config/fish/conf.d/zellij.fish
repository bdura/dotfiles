# Zellij tab name auto-updater
#
# Automatically updates Zellij tab names with the current directory path.
# Includes git repository information when available.
# Uses fish's on-variable hook to trigger updates on directory changes.

# Update Zellij tab name with the current directory
...
# Run on zellij start-up, without waiting for a directory change
_zellij_update_tabname
